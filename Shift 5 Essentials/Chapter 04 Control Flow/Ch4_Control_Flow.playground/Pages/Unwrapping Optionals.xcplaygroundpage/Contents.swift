 ...
 */
// Test variables
var itemGathered: String? = "Diamond sword"
...
if let shopOpen = isShopOpen, let searchedItem = blacksmithShop["Shield"]{
    print("we're open \(shopOpen) and we've a \(searchedItem) in stock")
}else{
    print("Sorry, either we've not open or we don't have your item")
}
