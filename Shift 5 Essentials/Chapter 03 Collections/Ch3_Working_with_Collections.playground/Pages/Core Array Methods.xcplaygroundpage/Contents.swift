...
var charactersClasses = ["Ranger","Paladin","Druid"]
charactersClasses.append("Gunslinger")
charactersClasses += ["Healer","Berserker"]

//Inserting and removing items
charactersClasses.insert("Beast Master", at: 2)
charactersClasses.remove(at: 1)

// Ordering and querying values
var reversedClasses = charactersClasses.reversed()
var sortClasses = charactersClasses.sorted()

charactersClasses.contains("Ranger")

//print(charactersClasses)
