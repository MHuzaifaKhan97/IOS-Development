 ...
 */
// 1
var shopItemsArray: Array<String> = ["Meat","Biscuit","Chocolate"]
...
// 2
shopItemsArray.contains("Soap")

// 3
shopItemsArray.insert("Soap", at: 2)

// 4
var selectedItem = shopItemsArray[0]

// 5
var selectedItemPrice = shopItemsDictionary["Meat"]

// 6
var fullArmorSet: Set<String> = ["A","B","C","D"]
var currentArmorSet: Set<String> = ["A","B"]

// 7
fullArmorSet.subtracting(currentArmorSet)

// 8
var armorPieceTuple =  (name:"ABC", cost:30,canEquip:true)
