...
var rareDagger = Item(description: "A unique dagger of unknow region", previousOwner: nil)
var daggerOwner = Owner(name: "The great thief")
rareDagger.previousOwner = daggerOwner
rareDagger.previousOwner?.name = "The old merchant" // not allowed because the chain is break.
...
if let gemstoneObject = questDirectory["Fetch Gemstones"]?["Objective"]{
    print(gemstoneObject)
}
