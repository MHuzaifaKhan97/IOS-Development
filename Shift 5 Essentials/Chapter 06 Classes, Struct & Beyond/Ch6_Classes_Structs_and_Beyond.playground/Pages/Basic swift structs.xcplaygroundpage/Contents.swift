 ...
 */
//struc has similar syntax and functionalities with class but used for diffrent sintuations
// better used for modeling where inheritence is not needed.
// struct comes with default initializer
...
var objectives = ["Find the lost cat","Collect all gemstones","Defeat the bigboss"]
...
//doesnot change the values of defaultlevel because its have a copy of level1
